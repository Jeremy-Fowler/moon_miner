 ...
 */
  ...
  get purchaseButtonHTMLTemplate() {
    ...
    <div class="d-flex gap-3 mb-2">
      <button onclick="app.upgradesController.purchaseUpgrade('${this.name}', '${this.type}')" class="btn btn-${this.type == 'click' ? 'primary' : 'danger'} fs-3" ${AppState.cheese < this.price ? 'disabled' : ''}>
